...
class MacroCalc extends Component{
    ...
    render() {
        const { height, age, weight, bodyfat, activity, tenacity, goal, gender } = this.props        
        return(
            <section>
                <p>Age</p>
                ...
                <p>Activity Level</p>
                <select className="macro-input" onselect={(e) => this.props.updateActivity(e.target.value)}>
                ...
                <p>Goal</p>
                <select className="macro-input" onselect={(e) => this.props.updateGoal(e.target.value)}>
                    <option value="gain">Gain Weight</option>
                    <option value="lose">Lose Weight</option>
                    <option value="maintain">Maintain Current Weight</option>
                </select>
                <p>Goal Tenacity</p>
                <select className="macro-input" onselect={(e) => this.props.updateTenacity(e.target.value)}>
                ...
                <p>Gender</p>
                <select className="macro-input" onselect={(e) => this.props.updateGender(e.target.value)}>
